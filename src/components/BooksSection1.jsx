...
export default function BooksSection1() {
  ...
  return (
    <section id = "books" className="py-16 px-6 md:px-12 bg-gradient-to-b from-white to-orange-50 dark:from-zinc-900 dark:to-zinc-950 relative">
      {/* Top Wave SVG */}
      ...
      {selectedBook ? (
        ...
        <div className="container mx-auto space-y-16 relative z-10">
          ...
          >
            <button className="px-8 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-medium rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 dark:from-orange-600 dark:to-pink-600">
              Load More Stories
            </button>
          </motion.div>
        </div>
